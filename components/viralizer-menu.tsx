...
import { Home, ImageIcon, Palette, Crown, User, MessageSquare, Zap, Sparkles, Edit } from "lucide-react"
...
export function ViralizerMenu({ isAuthenticated = false, isPremium = false }: ViralizerMenuProps) {
  ...
  // Filter menu items based on authentication and premium status
